# Contributing to the Simlife Registry

Are you ready to contribute to the Simlife Registry? We'd love to have you on board, and we will help you as much as we can.

Our contributing guidelines are basically the same as [the Simlife generator contributing guidelines](https://github.com/simlife/generator-simlife/blob/master/CONTRIBUTING.md).
...
You can request a new feature by submitting a ticket to our [GitHub issues](https://github.com/simlife/simlife-registry/issues). If you
...
Before you submit your issue search the [archive](https://github.com/simlife/simlife-registry/issues?utf8=%E2%9C%93&q=is%3Aissue), maybe your question was already answered.
...
* **Simlife Registry Version(s)** - is it a regression?
* **Browsers and Operating System** - is this a problem with all browsers or only IE8?

Click [here](https://github.com/simlife/simlife-registry/issues/new) to open a bug issue with a pre-filled template. For feature requests and enquiries you can use [this template][feature-template].
...
* Search [GitHub](https://github.com/simlife/simlife-registry/pulls?utf8=%E2%9C%93&q=is%3Apr) for an open or closed Pull Request
...
* All files must follow the [.editorconfig file](http://editorconfig.org/) located at the root of the Simlife Registry project. Please note that generated projects use the same `.editorconfig` file, so that both the generator and the generated projects share the same configuration.
